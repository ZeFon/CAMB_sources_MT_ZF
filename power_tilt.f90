    ...
    Type InitialPowerParams
		...
		real(dl) pri_k_c, pri_l_c !scale of modifications to primordial power and porwer for changes
	...
	!read the primordial Pk corrections
	InitPower%pri_k_c = Ini_Read_Double_File(Ini,'pri_kc',InitPower%pri_k_c)
	InitPower%pri_l_c = Ini_Read_Double_File(Ini,'pri_lc',InitPower%pri_l_c)
	InitPower%expcor = Ini_read_Logical('expcor',.false.)
