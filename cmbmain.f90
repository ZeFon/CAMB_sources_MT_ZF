    ...
    do i =0, num_redshiftwindows
        ...
        if (ThisCT%limber_l_min(s_ix)/=0) then
            ...
            if (i==0) then
                ...
                if (W%kind==window_lensing .or. W%kind==window_counts .and. W%DoRedshiftLensing) then
                    n2 = TimeSteps%npoints-1
                else
                    n2 = min(TimeSteps%npoints-1,Ranges_IndexOf(TimeSteps, W%tau_end))
                end if
                if (W%kind==window_counts .and. W%DoRedshiftLensing) then
                        ...
                        if (CTrans%NumSources>2 .and. has_cl_2D_array) then
                            ...
                            do w_ix=1,3 + num_redshiftwindows
                                ...
                                if (w_ix>3) then
                                    ...
                                    if (Win%kind==window_counts .and. Win%DoRedshiftLensing) then
