	...
	DoTermsW = Ini_Read_Logical('DoTerms_per_Window', .false.)
    ...
    do i=1, num_redshiftwindows
        ...
        if (RedWin%kind == window_counts) then
			...
			elseif (ZdNdz=='hiim') then
				RedWin%dNdz = hiim
			elseif (ZdNdz=='halpha') then
				RedWin%dNdz = halpha
			...
			if (DoTermsW) then
				...
				RedWin%counts_timedelay = Ini_read_Logical('counts_timedelay('//trim(numstr)//')',.false.)
				RedWin%counts_ISW = Ini_read_Logical('counts_ISW('//trim(numstr)//')',.false.)
				RedWin%counts_potential = Ini_read_Logical('counts_potential('//trim(numstr)//')',.false.)
				RedWin%counts_velocity = Ini_read_Logical('counts_velocity('//trim(numstr)//')',.false.)
				...
				RedWin%counts_timedelay = Ini_read_Logical('counts_timedelay',.false.)
				RedWin%counts_ISW = Ini_read_Logical('counts_ISW',.false.)
				RedWin%counts_potential = Ini_read_Logical('counts_potential',.false.)
				RedWin%counts_velocity = Ini_read_Logical('counts_velocity',.false.)
	...
	!P%eps_ISW    = Ini_Read_Double('eps_ISW')
